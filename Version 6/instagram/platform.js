...
(function() {
    const instagramPlatform = {
        ...
        // Instagram opens videos in new tab (CDN links work fine)
        useDirectDownload: false,

        // Instagram uses React Fiber for thumbnail extraction
        ...
        extractVideoUrlFromDOM(el) {
            return null; // Instagram purely uses React Fiber extraction
        }
    };

    // Set for both worlds — whichever loads this file will use the appropriate one
    if (typeof window !== 'undefined') {
        window.ToystallerPlatform = instagramPlatform;        // MAIN world (interceptor)
        window.ToystallerActivePlatform = instagramPlatform;  // Content world (content_core)
    }
})();
